<nav class="bg-white border-b border-gray-100" data-mobile-nav>
    ...
    @auth
        ...
        @endauth
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button data-mobile-nav-toggle type="button" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
    ...
    <div id="mobile-nav-content" class="hidden sm:hidden">
        @auth
